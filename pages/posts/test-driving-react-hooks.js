  ...
  <PostLayout title='Test-driving React Hooks'>
    ...
    <section>
      ...
      <p>
        ...
        First, check your <span className='inset-code-sample'>package.json</span> file to ensure you
        have at least version <span className='inset-code-sample'>16.8.0</span> of React, as that is
        the first version containing hooks in the stable build. Next head to your terminal and add
        the dependencies for react-testing-library:
      </p>
      <h3>Using npm</h3>
