  ...
  <PostLayout title={'Test-Driving React Hooks'}>
    <article>
      <p>
        ...
        I'd like to focus on testing React hooks, specifically test-driving them into an
        application.
      </p>
      <p>
      ...
      <section>
        ...
        <p>
          ...
          with Enzyme, but, unfortunately, as of the time of this post it does not fully support
          hooks at this time. Follow <a href='https://github.com/airbnb/enzyme/issues/2011'>this</a>{' '}
          GitHub issue for more information and updates on its support for React hooks.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          ...
          mentioned before will be the <span className='inset-code-sample'>useState</span> hook. And
          we'll be making a simple counter with a button to increment it. Nothing fancy for this;
          using the testing library is the important part here. And so, we begin with a test in a
          file called <span className='inset-code-sample'>HookCounter.spec.js</span>:
        </p>
    ...
    <div>
      ...
      <section>
        ...
        <p>
          ...
          order to focus on the testing aspects. The code I originally wrote to figure this out can
          be found in this{' '}
          <a href='https://github.com/kyle-hall/react-hooks-with-typescript'>repo</a>. I was working
          on more than just one thing there - including TypeScript - but I liked what I ended up
          with, and maybe the steps of the commits will be helpful.
        </p>
        <p>
          If you have any comments or suggestions - or maybe just liked the article :) - please feel
          free to get in touch with me via Twitter using the link below. That's all for today.
