    ...
    <article>
      <section>
        ...
        <p>
          ...
          running to actually put those templates together with the content to get a webpage back
          out in the browser. A static site has all of this figured out ahead of time, and it
          doesn't need to do all of this construction on request.
        </p>
        <p>
          ...
          can also suck, but that's a topic for another day. The point is, with a SPA, the user
          sends the request, the browser gets a big ol' blob of JavaScript that gets parsed, and
          then some content gets rendered. With a static site, depending on how much JavaScript you
          add, the content is all figured out ahead of time, and that just gets rendered right there
          in your browser.
        </p>
        <p>
          Now, static sites don't have to be this basic. There are a lot of great things that can be
          done on top of this without breaking the idea of what being a static site means. I'll
