    ...
    <article>
      ...
      <section>
        ...
        <p>
          ...
          my personal preference as someone who likes functional programming. It is so much cleaner
          and doesn't have any of the problematic characteristics of ES6 classes that I'll get to
          below.
        </p>
        ...
        <p>
          ...
          uses classical inheritance; it uses prototypal inheritance. Classes are just syntatic
          sugar on top of the old function way of creating object in JavaScript. And, thus, I would
          like to avoid ES6 classes whenever I can.
        </p>
        <p>
...
`}</pre>
        ...
        <ul>
          ...
          <li>
            ...
            display in the text of the paragraph tag, and the button gets the setCount function as
            its click handler.
          </li>
          <li>
        ...
        <p>
          ...
          is I didn't have to use ES6 classes to create a React component with local state! And
          that's awesome!
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          the useState hook and also gets a good example of a closure and currying at the same time.
          I used <a href='https://elated-bohr-7e3d49.netlify.com/'>NES.css</a> to style that form,
          because it was fun.
        </p>
      </section>
    </article>
