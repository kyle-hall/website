      ...
      <article>
        ...
        <section>
          ...
          <ul style={blogStyles.contentStyle}>
            ...
            <li>
              ...
              <span style={blogStyles.insetStyle}>this</span>
              ...
              this <span style={blogStyles.insetStyle}>this</span> in Java or some other programming
              language.
            </li>
          </ul>
          <p style={blogStyles.contentStyle}>
            ...
            <span style={blogStyles.insetStyle}>typeof</span>
          ...
          <h3 style={blogStyles.headerStyles}>
        ...
        <section>
          ...
          <p style={blogStyles.contentStyle}>
            ...
            <span style={blogStyles.insetStyle}>componentDidMount</span>
            ...
            <span style={blogStyles.insetStyle}>useEffect</span> hook and{' '}
            <span style={blogStyles.insetStyle}>componentDidMount</span>. So, more to come on that
            in the future.
          </p>
          <p style={blogStyles.contentStyle}>
            There are many hooks from React. The simplest is{' '}
            <span style={blogStyles.insetStyle}>useState</span>, which I'll be discussing here.
          ...
          <p style={blogStyles.contentStyle}>
            ...
            <span style={blogStyles.insetStyle}>useState</span>
            hook:
          </p>
...
`}</pre>
          <p style={blogStyles.contentStyle}>Cool, so let's break that down.</p>
          <ul style={blogStyles.contentStyle}>
            <li>We've create a functional component, so far so good.</li>
            <li>
              Then we see something that may look a little weird:{' '}
              <span style={blogStyles.insetStyle}>const [count, setCount] = useState(0)</span>
              <p>
          ...
          <p style={blogStyles.contentStyle}>Wait, hold on. What's that I hear you say?</p>
          <p style={blogStyles.contentStyle}>"So you made a counter with a button, big whoop"</p>
          <p style={blogStyles.contentStyle}>
