    ...
    <PostLayout title={'Starting a React Project from Scratch with Parcel.js'}>
      <header>
        <p>
          ...
          quickly, but usually leaves me with a project that's got too much going on for me. I
          usually put up with that because I don't want to deal with creating my own Webpack config.
          But, with the advent of <a href='https://parceljs.org'>Parcel.js</a>, I don't need to
          worry about that. So, let's get started.
        </p>
        <p>
          Small disclaimer: I'm going to use Yarn throughout this article, and I won't be showing
          the equivalent commands using npm. This is for the sake of brevity. In case, you'd like
          one, here's a quick conversion guide:
        </p>
