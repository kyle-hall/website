...
const Post = props => (
  <PostLayout title={'Test-Driven Binary Search Tree with Kotlin, Part 1'}>
    <p>
      ...
      development and some computer science all using the Kotlin programming language. I don't have
      a comment section figured out, yet, so for now, if you have feedback please contact me via{' '}
      <a href='https://twitter.com/khalligans47'>Twitter</a>.
    </p>
    <section>
    ...
    <section>
      ...
      <p>
        ...
        <span className='inset-code-sample'>build.gradle</span> file you'll need to get started with
