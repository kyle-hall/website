      ...
      <article>
        ...
        <section>
          ...
          <p>
            ...
            new tree when operated on. I tend to like a functional programming style, so I'll be
            writing a recursive BST for this article. I'll likely go into more detail about
            functional programming in a future article.
          </p>
        </section>
        <section>
          <h2>The Setup</h2>
...
`}
            ...
            Be sure to replace the Kotlin version with the one you have. If you're using an IDE,
            such as IntelliJ, it should warn you if the version I have is different from its
            version.
          </p>
