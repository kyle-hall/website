...
const Post = props => (
  <PostLayout title={'Test-Driven Binary Search Tree with Kotlin, Part 1'}>
    <article>
      <p>
      ...
      <section>
        ...
        <p>
          ...
          process for writing better code by writing the tests first. Test-driven development
        ...
        <ol>
          ...
          <li>
            Once you're green, refactor the code you wrote so it isn't just a mad grab at the
        ...
        <p>
          ...
          Starting with a failing test gives you a place to start and a clear goal in mind: "I need
          to fix this thing and make the test pass." Then, when make your code changes and see the
          test go green, you know your code actually works because the tests failed before you wrote
          it and passes aftewards.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          implement this BST, imperative and recursive. Briefly, the difference is that the
          imperative approach modifies the BST in place, while the recursive approach returns a new
          tree when operated on. I tend to like a functional programming style, so I'll be writing a
          recursive BST for this article. I'll likely go into more detail about functional
          programming in a future article.
        </p>
      </section>
      <section>
        <h2>The Setup</h2>
        <p>
          ...
          more about creating new Gradle-based projects in the future. But, that's outside the scope
          of this article, so, for now, here's the{' '}
...
`}
          ...
          Be sure to replace the Kotlin version with the one you have. If you're using an IDE, such
          as IntelliJ, it should warn you if the version I have is different from its version.
        </p>
